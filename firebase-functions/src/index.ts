...
export const processTradeCompletion = functions.firestore
...
export const processKYCVerification = functions.https.onCall(async (data, context) => {
...
// Helper functions
async function sendTradeCompletionNotifications(buyerId: string, sellerId: string, tradeData: any) {
  try {
